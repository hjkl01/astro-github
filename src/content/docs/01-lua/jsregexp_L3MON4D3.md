...
https://github.com/L3MON4D3/jsregexp

> Description from GitHub: Provides (a subset of) ECMAScript regular expressions. Uses `libregexp` from Fabrice Bellard's QuickJS.
...
To install `jsregexp` globally with [luarocks](https://luarocks.org/modules/kmarius/jsregexp), run
