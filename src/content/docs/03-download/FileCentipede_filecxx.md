...
- **多协议支持**：兼容 HTTP、HTTPS、FTP、FTPS、SSH、SFTP、BitTorrent、Magnet、WebDAV 等协议。
- **流媒体支持**：支持 m3u8 流媒体任务，包括 AES-128 解密。
- **浏览器集成**：支持 Chrome 和 Firefox 浏览器集成，可捕获视频、音频和磁力链接。
- **队列管理**：支持批量下载任务管理、暂停/恢复/删除操作。
- **资源监控**：实时显示下载速度、剩余时间和已用带宽。
- **代理支持**：内置代理管理，支持 HTTP/SOCKS 代理。
- **站点规则**：自定义站点规则以优化下载。
- **校验和工具**：内置校验和工具用于文件完整性检查。
- **文件管理**：支持文件合并、创建种子、种子与磁力链接转换。
- **远程下载**：支持远程下载功能。
...
- **自定义规则**：设置下载路径、文件过滤规则。
- **种子管理**：支持 BitTorrent 种子创建、导出和转换。
- **工具集成**：内置翻译工具、HTTP 工具、编码解码工具、正则测试等。
- **网页抓取**：从网页下载所有链接或特定内容。
