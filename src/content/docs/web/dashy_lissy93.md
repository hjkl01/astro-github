...
- **状态监控**：集成服务健康检查，显示应用程序的在线/离线状态，支持全局启用状态检查。
- **自定义小部件**：添加动态内容，如时钟、待办事项列表或自定义脚本输出。支持第三方小部件如 Glances（CPU、内存监控）、AdGuard Home DNS 信息、Uptime Kuma 等。
- **多语言支持**：内置国际化功能，包括中文界面。
- **导出/导入**：轻松备份和恢复仪表板配置。
- **Docker 支持**：一键部署，适合服务器或 NAS 环境，支持资源限制和安全配置。
- **隐私与安全**：支持禁用 Web 搜索、状态检查、错误报告等功能，确保自托管隐私。
