...
> Description from GitHub: Single tabpage interface for easily cycling through diffs for all modified files for any git rev.
...
The file history view allows you to list all commits that affected a given set of paths, and view the changes made in a diff split. This is a porcelain interface for git-log, and supports a good number of its options. Things like:
...
For information about additional `[options]`, visit the [documentation](https://github.com/sindrets/diffview.nvim/blob/main/doc/diffview.txt).
...
Additionally check out [USAGE](/sindrets/diffview.nvim/blob/main/USAGE.md) for examples of some more specific use-cases.
