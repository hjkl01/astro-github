...
> Description from GitHub: Blazing fast Neovim framework providing solid defaults and a beautiful UI, enhancing your neovim experience.
...
1. **安装 Neovim**：确保安装 Neovim 0.8+ 版本。从官网下载或使用包管理器（如 `brew install neovim` on macOS）。
2. **克隆项目**：
   ```
