...
Cemu 是一款针对 Windows、Linux 和 macOS 的 Wii U 模拟器，采用开源代码，目标是提供与原机相当甚至更高的兼容性和性能。  
该项目使用 C/C++ 开发，支持 4K 超分辨率渲染、完整的游戏手柄和网络功能，并拥有插件系统以扩展功能。
...
2. **编译**
   ...
   - 在 Linux 和 macOS 上，查看 `BUILD.md` 获取详细构建指令。
...
> **注**：本项目为开源项目，使用 MPL-2.0 许可证。请遵守相应条款进行使用与分发。
